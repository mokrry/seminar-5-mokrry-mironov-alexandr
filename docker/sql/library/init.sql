...
-- Добавляем выдачи Иванову Ивану (ID=10000),
-- чтобы запросы про "что брал Иван Иванов" и "кто брал те же книги" не были пустыми
INSERT INTO Borrowing (ID, ISBN, CopyNumber, ReturnDate)
VALUES
  (10000, '1234567890123', 1, '2024-04-01'), -- "Горы Кавказа" (вернул)
  (10000, '2345678901234', 1, NULL)          -- "Путешествие в Альпы" (ещё не вернул)
